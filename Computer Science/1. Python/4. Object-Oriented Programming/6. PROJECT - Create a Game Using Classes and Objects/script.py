...
class User:
  ...
  def __repr__(self):
    return f"User(name='{self.name}', surname='{self.surname}', username='{self.username}, surname='{self.surname}'')"
...
class Stock:
  # check_user = input("Please, type your username: ")
  # if check_user in registered_usernames:
  #   pass
  # else:
  #   print("User not identified, quitting")
  #   exit()
